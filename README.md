...
Latest release: 0.1.0 - phpLDAPadmin 1.2.3 (with php7 patch) on an Ubuntu Bionic base - [Changelog](CHANGELOG.md) | [Docker Hub](https://hub.docker.com/r/osixia/phpldapadmin/) 
